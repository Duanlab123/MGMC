function w=MGMC_MM(w,f,opt,level)
alpha = opt.alpha;
...
[w]=MGMC_DDM(noise,w,row_odd_idx,col_odd_idx,row_odd,col_odd,bnd_idx,bnd_idy,level,alpha,noise_ch1,nphi_1,vx_1,vy_1,dv1,s1,mcpara1,uc1,u1ch_mid1);
[w]=MGMC_DDM(noise,w,row_odd_idx,col_even_idx,row_odd,col_even,bnd_idx,bnd_idy,level,alpha,noise_ch2,nphi_2,vx_2,vy_2,dv2,s2,mcpara2,uc2,u2ch_mid1);
[w]=MGMC_DDM(noise,w,row_even_idx,col_odd_idx,row_even,col_odd,bnd_idx,bnd_idy,level,alpha,noise_ch3,nphi_3,vx_3,vy_3,dv3,s3,mcpara3,uc3,u3ch_mid1);
[w]=MGMC_DDM(noise,w,row_even_idx,col_even_idx,row_even,col_even,bnd_idx,bnd_idy,level,alpha,noise_ch4,nphi_4,vx_4,vy_4,dv4,s4,mcpara4,uc4,u4ch_mid1);
end